      ...
      <div className="relative pt-4">
        ...
        <div className="w-full flex flex-col items-center md:mt-8 sm:mt-4 ">
          ...
          <div className="text-center mt-5 ">
            <span className="block text-3xl font-semibold bg-gradient-to-l from-[#42D392] to-blue-300 bg-clip-text text-transparent">
              Hi , I`m Rendani, a Fullstack Web Developer
            </span>
            <span className="block text-lg text-gray-400 font-semibold pt-4">
          ...
          <div className="pt-6">
            <button
              className="px-[1px] rounded-md shadow-md border-transparent hover:bg-gradient-to-r transition-all duration-300 delay-150 ease-in-out cursor-pointer bg-clip-border bg-gradient-to-bl from-blue-400 to-green-300 py-[1px]"
